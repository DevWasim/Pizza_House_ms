...
<body id="body">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="./login/index.php" class="btn btn-outline-danger text-light py-2 px-4">Log In</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-light animated slideInLeft" id="enjoy_our">Enjoy Our<br>Delicious Pizza</h1>
                            <p class="text-warning mb-4 pb-2" id="enjoyour">Hello !

                                &nbsp; To enjoy our special deals Click on the bellow button.
                            </p>
                            <a href="#" class="btn btn-outline-warning py-sm-3 px-sm-5 me-3 animated slideInLeft text-light"><b>
                                    Click Here</b></a>
                        </div>
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="card m-5 mb-5" style="width: 18rem;">
                        <img src="./noneed/pizza1.jpg" class="card-img-top mt-2 rounded-2" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Pizza</h5>
                            <span class="card-text">Small Pizza with  1L Drink</span>
                            <p class="card-text text-danger rounded-3"><strong>Price :600 PKR</strong></p>
                            <a href="login/login.php" class="btn btn-warning col-md-12 m-auto"><b>Login</b></a>
                        </div>
                    </div>
                    ...
                    <div class="card m-5 mb-5" style="width: 18rem;">
                        <img src="./noneed/burger1.png" class="card-img-top mt-2 mb-5 rounded-2" alt="...">
                        <div class="card-body mt-3">
                            <h5 class="card-title"><?php echo $item['flavor']; ?></h5>
                            <span class="card-text">Burger with Fries</span>
                    ...
                    <!-- card 3  -->
                    <div class="card m-5 mb-5" style="width: 18rem;">
                                <img src="./noneed/pizza2.jpg" class="card-img-top mt-2 rounded-2" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Meat Pizza</h5>
                                    <span class="card-text">Pizza with Fries and 1L Drink</span>
                                    <p class="card-text text-danger rounded-3"><strong>Price : 1200 PKR</p>
                                    <a href="login/login.php" class="btn btn-warning col-md-12 m-auto"><b>Login</b></a>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <a class="btn btn-outline-danger py-3 px-5 mt-2" href="#">Log In to Read More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-0 bg-light" id="ordernow">
        <div class="col-md-6">
            <div class="video">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <!-- error  -->
                <div>
                    <div class="text-center bg-danger text-light fw-bolder m-auto col-md-5 mt-2 mb-2"><b><?php echo $error ?></b></div>
                </div>
                <div>
                    <div class="text-center bg-success text-light fw-bolder m-auto col-md-6 mb-2"><b><?php echo $success ?></b></div>
                </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value="<?php echo $ordername; ?>">
                                <label for="name">Your Name</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" name="email" class="form-control" id="email" placeholder="Your Email" value="<?php echo $orderemail; ?>">
                                <label for="email">Your Email</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="phone" name="phone" class="form-control" id="phone" placeholder="Your phone" value="<?php echo $orderphone; ?>">
                    ...
                    <div class="col-12 mt-3 mb-3">
                        <div class="form-floating">
                            <textarea name="address" class="form-control" placeholder="Special Request" id="message" style="height: 90px; resize: none;"><?php echo $orderaddress; ?></textarea>
    ...
    <!-- Testimonial Start -->
    <div class="container-xxl py-5 wow fadeInUp d-grid" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                <h5 class="section-title ff-secondary text-center text-warning fw-normal">Testimonial</h5>
                <h1 class="mb-5 text-light">Our Clients Review's</h1>
            </div>
